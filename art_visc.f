     ...
     &           pair_i,pair_j,itype,w,dwdx,dvxdt,dedt)
...
c     Calculate muv_ij = hsml v_ij * r_ij / ( r_ij^2 + hsml^2 etq )
            
          muv = mhsml*vr/(rr + mhsml*mhsml*etq)
